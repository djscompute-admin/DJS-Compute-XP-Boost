      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 text-center z-10">
            <p className="jolly-lodger-regular text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-2">
              First Prize
            </p>
            <p className="jolly-lodger-regular text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold">
              ₹5K
            </p>
          </div>
          ...
          <div className="absolute top-[25%] left-[5%] sm:left-[8%] text-center z-10">
            <p className="jolly-lodger-regular text-xl sm:text-2xl md:text-3xl lg:text-4xl mb-2">
              Second Prize
            </p>
            <p className="jolly-lodger-regular text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
              ₹3K
            </p>
          </div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            <Image
              ...
              width={300}
              height={400}
              className="w-96 h-auto sm:w-56 md:w-64 lg:w-72 animate-float object-contain"
