...
export default function Footer() {
  return (
    <footer 
      id="contact" 
      className="relative text-white select-none min-h-[300px]"
      style={{
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16 md:gap-20 lg:gap-32">
          {/* Social media */}
          <div className="text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4 sm:gap-5">
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/djscompute/" target="_blank" aria-label="LinkedIn" className="hover:opacity-80 transition-opacity">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/djscompute/" target="_blank" aria-label="Instagram" className="hover:opacity-80 transition-opacity">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="white" className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10">
